<?php
// Principal amb formulari per pujar arxius.
            ...
            $(document).ready(function () {
                ...
                $("#formulari").on("submit", function (e) {
                    ...
                    $.ajax({// enviam per ajax
                        url: "rebarxius.php", // paginad de desti.
                        type: "post", // Metode
                                ...
                                <form enctype="multipart/form-data" id="formulari" method="post">
                                    <div class="row">
                                        <div class="col-xs-12 col-md-4 col-lg-4">
                                            <label>Nom per la carpeta:</label> <input type="text" name="nom" placeholder="Escriu el teu nom" class = "form-control"><br/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-12 col-md-4 col-lg-4">
                                            <label>Arxiu a pujar:</label><input  type="file" id="arxiu" name="arxiu" class = "form-control"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-12 col-md-6 col-lg-6">
                                            <label>Descripcio:</label> <textarea cols="90" rows="4" name="descripcio" class = "form-control"></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-12 col-md-6 col-lg-6">
                                            <label>De quina casa?</label>
                                            <select name ="casa" class = "form-control4l">
                                                <?php
                                                ...
                                                foreach ($result as $key => $casa) {
                                                    echo '<option value = "' . $casa->CAS_codi . '">' . $casa->CAS_nom . '</option>';
                                                }
                                                ?>
                                    ...
                                    <br><input type="submit" value="Pujar arxius" class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Pujar arxiu."/>
